...
function renderProduto(produto) {
    ...
    image.src = `${ip}/api/productImagesTransparent/${produto.id}/1.jpg`;
    image.alt = "";
    ...
    if (produto.estoque) {
        ...
        buttonElement.innerHTML = "produto <br> indisponível";
    ...
    const valueSelect = purchasedProduct
...
async function render() {
    ...
    fetch(`${ip}/api/products/incrementView/${id}`);
